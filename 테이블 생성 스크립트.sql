...
COMMENT ON COLUMN "TB_REPORT"."REP_AUTHOR" IS '작성자';
...
COMMENT ON COLUMN "TB_INQUIRY"."INQ_AUTHOR" IS '작성자';
...
COMMENT ON COLUMN "TB_EVENT_COMMENT"."EVENT_COM_AUTHOR" IS '이벤트댓글작성자';
